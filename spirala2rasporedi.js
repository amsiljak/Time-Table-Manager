function init(){
    ...
    dodajAktivnost(null,"WT","predavanje",9,12,"Srijeda"); 

    iscrtajRaspored(okvir,["Ponedjeljak","Utorak","Srijeda","Četvrtak"],9,24);

    dodajAktivnost(okvir,"WT","predavanje",-9,12,"Srijeda");
    dodajAktivnost(okvir,"WT","vježba",10.2,12,"Utorak");
    dodajAktivnost(okvir,"PWS","predavanje",17,14,"Ponedjeljak");
    dodajAktivnost(okvir,"PWS","predavanje",17,26,"Ponedjeljak");
